...
else
{
	$icon_url_template = "<script>\n".
		...
		"}\n".
		"</script>\n".
		"<a href=\"http://twitter.com/home/?status=#PAGE_URL#+#PAGE_TITLE_ORIG#\" onclick=\"return twitter_click_".$arResult["COUNTER"]."('#PAGE_URL#');\" target=\"_blank\" class=\"twitter\" title=\"".$title."\"><i class=\"fa fa-twitter\" aria-hidden=\"true\"></i> Twitter</a>\n";
}
